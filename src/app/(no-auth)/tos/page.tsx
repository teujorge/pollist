...
export default function TermsOfServicePage() {
  return (
    <main className="gap-2 [&>h2]:pt-10 [&>h2]:text-3xl [&>h2]:font-semibold [&>p]:py-2 [&>ul]:list-disc [&>ul]:pl-6">
      ...
      <p>
        The Service is intended for your personal, non-commercial use. Pollist
        grants you a limited, non-exclusive, non-transferable, and revocable
        license to access and use the Service for its intended purposes, subject
      ...
      <p>
        ...
        and for the User Content that you post. You represent and warrant that
        you own or have the necessary rights to all of your User Content and
        that use of your User Content does not infringe, misappropriate, or
      ...
      <p>
        ...
        guarantees regarding its integrity, accuracy, or quality. We assume no
      ...
      <p>
        ...
        our Privacy Policy. If you do not agree to these Terms, you must not
